...
const Hero = ({ onOpenCV }) => {
  return (
      ...
      <div className="absolute inset-0 z-10 flex flex-col md:flex-row-reverse items-center justify-center pointer-events-none px-6 md:px-12 gap-8 md:gap-16">
        ...
        >
          ...
          >
            {/* Actual Image */}
            <div
              className="w-full h-full rounded-full overflow-hidden absolute inset-0 m-auto"
              style={{
                width: "calc(100% - 16px)",
    ...
    inset: -10px;
    } rounded-full border-b-2 border-purple-500/50 animate-[spin_8s_linear_infinite_reverse]"
            ></div>
          </motion.div>
        </motion.div>
